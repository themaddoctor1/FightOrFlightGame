 ...
 * @author Christopher
 */
public class HealthDrainDrone extends Creature{
    
    private double preferredAltitude = 4;
    
    public HealthDrainDrone(Coordinate pos){
        super(pos,0.3,25);
